...
func TestMainEsempioConFileSottoalbero(t *testing.T) {
	LanciaGenericaConFileInOutAtteso(t,
		prog,
		"input-es.txt",
		"output-frigorifero.txt",
		"frigorifero")
}

func TestMainEsempioConFileDueAlberi1(t *testing.T) {
	LanciaGenericaConFileInOutAtteso(t,
		prog,
		"input-foresta.txt",
		"output-foresta-letto.txt",
		"letto")
}

func TestMainEsempioConFileDueAlberi2(t *testing.T) {
	LanciaGenericaConFileInOutAtteso(t,
		prog,
		"input-foresta.txt",
		"output-foresta-tavolo.txt",
		"tavolo")
}
